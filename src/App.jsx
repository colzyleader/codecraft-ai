...
- For images use https://loremflickr.com/600/400/KEYWORD (e.g. /600/400/burger, /600/400/chicken, /600/400/fries, /600/400/pizza, /600/400/restaurant). Use different keywords per item. Every card and hero MUST have an <img> tag with onerror="this.style.background='#333'"
- All buttons must work (tabs switch, forms validate, nav scrolls, hamburger toggles)
- Responsive at 768px
- Modern dark theme unless specified otherwise
